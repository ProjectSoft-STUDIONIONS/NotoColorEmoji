...
$this->set('toolbar3', 'image media | link unlink | table | charmap | spellchecker', 'string');
// Четвёртая строка тулбара (отключаем)
$this->set('toolbar4', 'notocoloremoji-smiles notocoloremoji-emotics notocoloremoji-people notocoloremoji-animals notocoloremoji-nature notocoloremoji-food notocoloremoji-travel notocoloremoji-activy notocoloremoji-objects notocoloremoji-symbols notocoloremoji-flags', 'string');
